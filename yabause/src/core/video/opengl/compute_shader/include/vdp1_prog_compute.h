...
// "    float dp = float(Pn.x-P0.x+1)/float(P1.x-P0.x+1);\n"
"    vec4 pixout = getMeshedPixel(pixcmd, dp, Pn, valid);\n"
"    if (valid) { \n"
"     imageStore(outSurface,Pn,pixout);\n"
// "     if (pixcmd.lextendx * a.x == -1) imageStore(outSurface,Pn+ivec2(pixcmd.lextendx, 0),pixout);\n"
// "     if (pixcmd.lextendy * a.y == -1) imageStore(outSurface,Pn+ivec2(0,pixcmd.lextendy),pixout);\n"
"    }\n"
"    i++;\n"
"   }\n"
"   a.z += vector.y;\n"
...
// "    if (pixcmd.rextendx * a.x == 1) imageStore(outSurface,P1+ivec2(delta.x,0)+ivec2(pixcmd.rextendx, 0),pixout);\n"
// "    if (pixcmd.rextendy * a.y == 1) imageStore(outSurface,P1+ivec2(delta.x,0)+ivec2(0,pixcmd.rextendy),pixout);\n"
"   }\n"
"  }\n"
" } else {\n"
...
// "    float dp = float(Pn.y-P0.y+1)/float(P1.y-P0.y+1);\n"
"    vec4 pixout = getMeshedPixel(pixcmd, dp,Pn, valid);\n"
"    if (valid) { \n"
"     imageStore(outSurface,Pn,pixout);\n"
// "     if (pixcmd.lextendx * a.x == -1) imageStore(outSurface,Pn+ivec2(pixcmd.lextendx, 0),pixout);\n"
...
// "    if (pixcmd.rextendx * a.x == 1) imageStore(outSurface,P1+ivec2(0,delta.y)+ivec2(pixcmd.rextendx, 0),pixout);\n"
// "    if (pixcmd.rextendy * a.y == 1) imageStore(outSurface,P1+ivec2(0,delta.y)+ivec2(0,pixcmd.rextendy),pixout);\n"
"   }\n"
"  }\n"
" }\n"
"}\n";
