...
"   if (valid) {\n"
"    ivec2 Pn = P;\n"
"    vec4 pixout = getMeshedPixel(pixcmd, float(Pn.x-P0.x+1)/float(P1.x-P0.x+1), Pn, valid);\n"
...
"   if (valid) {\n"
"    ivec2 Pn = P;\n"
"    vec4 pixout = getMeshedPixel(pixcmd, float(Pn.y-P0.y+1)/float(P1.y-P0.y+1),Pn, valid);\n"
"    if (valid) imageStore(outSurface,Pn,pixout);\n"
"   }\n"
"   a.z += vector.x;\n"
...
" if (valid) {\n"
"  vec4 pixout = getMeshedPixel(pixcmd, 1.0, P1, valid);\n"
