...
"}\n"
"bool isOnLine(ivec2 P, ivec2 P0, float slope, ivec2 a){\n"
"  return round((P.x-P0.x+0.5*a.x)*slope) == (P.y-P0.y);\n"
"}\n"
"bool onChange(ivec2 P, ivec2 P0, float slope, ivec2 a, int orientation, int cidx, int lidx) {\n"
"  if ((a.x == a.y)^^(orientation==1)) \n"
"   return (cidx>lidx) && isOnLine(P+ivec2( a.x,0), P0, slope, a) && isOnLine(P+ivec2(0,-a.y), P0, slope, a);\n"
"  else \n"
"   return (cidx<lidx) && isOnLine(P+ivec2(-a.x,0), P0, slope, a) && isOnLine(P+ivec2(0, a.y), P0, slope, a);\n"
"}\n"
...
"  if((P1.x - P0.x)/upscale.x == 0){\n"
"   pixelOnLine = (Pn.x == P0.x);\n"
"  } else {\n"
"   float slope = float((P1.y-P0.y)/upscale.y)/float((P1.x-P0.x)/upscale.x);\n"
"   pixelOnLine = isOnLine(Pn/upscale, P0/upscale, slope, a);\n"
"   pixelOnLine = pixelOnLine || (onChange((Pn)/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx));\n"
"   pixelOnLine = pixelOnLine ||onChangeOpposite(Pn/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx);\n"
"   if (greedy) {\n"
"    bool isGreedy = false;\n"
"    for (int i = 0; i<upscale.x; i++){\n"
"     isGreedy = isGreedy || ( (lidx == i) && onChange((Pn+ivec2(-i*a.x,-i*a.y))/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx));\n"
"    }\n"
"    pixelOnLine = pixelOnLine || isGreedy;\n"
"   }\n"
"  }\n"
"  if (pixelOnLine) {\n"
