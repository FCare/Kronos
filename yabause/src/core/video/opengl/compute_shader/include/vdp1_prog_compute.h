...
"}\n"
"bool isOnLine(ivec2 P, ivec2 P0, ivec2 P1, ivec2 a){\n"
" if (P1.x == P0.x) return true;\n"
" float slope = float(P1.y-P0.y)/float(P1.x-P0.x);\n"
" float projY = abs(float(P.x-P0.x)*slope);\n"
" int testY = int(floor(projY));\n"
" if (fract(projY)>= 0.5) testY+= 1;\n"
" return (testY == abs(P.y-P0.y));\n"
"}\n"
"bool onChange(ivec2 P, ivec2 P0, ivec2 P1, ivec2 a, int orientation, int cidx, int lidx) {\n"
"  if ((a.x == a.y)^^(orientation==1)) \n"
"   return (cidx>lidx) && isOnLine(P+ivec2( a.x,0), P0, P1, a) && isOnLine(P+ivec2(0,-a.y), P0, P1, a);\n"
"  else \n"
"   return (cidx<lidx) && isOnLine(P+ivec2(-a.x,0), P0, P1, a) && isOnLine(P+ivec2(0, a.y), P0, P1, a);\n"
"}\n"
"bool onChangeOpposite(ivec2 P, ivec2 P0, ivec2 P1, ivec2 a, int orientation, int cidx, int lidx) {\n"
"  if ((a.x == a.y)^^(orientation==1)) \n"
"   return (cidx<lidx) && isOnLine(P+ivec2(-a.x,0), P0, P1, a) && isOnLine(P+ivec2(0, a.y), P0, P1, a);\n"
"  else \n"
"   return (cidx>lidx) && isOnLine(P+ivec2( a.x,0), P0, P1, a) && isOnLine(P+ivec2(0,-a.y), P0, P1, a);\n"
"}\n"
"bool onChangeAliased(ivec2 P, ivec2 P0, ivec2 P1, ivec2 a, int orientation, int cidx, int lidx) {\n"
"  if ((a.x == a.y)^^(orientation==1)) \n"
"   return ((cidx>lidx) && isOnLine(P+ivec2(2*a.x,0), P0, P1, a) && isOnLine(P+ivec2(0,-a.y), P0, P1, a)) "
"          || isOnLine(P+ivec2( a.x,0), P0, P1, a) && isOnLine(P+ivec2(0,-a.y), P0, P1, a);\n"
"  else \n"
"   return ((cidx<lidx) && isOnLine(P+ivec2(-2*a.x,0), P0, P1, a) && isOnLine(P+ivec2(0, a.y), P0, P1, a)) "
"          || isOnLine(P+ivec2(-a.x,0), P0, P1, a) && isOnLine(P+ivec2(0, a.y), P0, P1, a);\n"
"}\n"
...
"  mat2 transrev = trans;\n"
"  ivec2 P0 = ivec2(trans*vec2(pixcmd.CMDXA, pixcmd.CMDYA)*upscale);\n"
"  ivec2 P1 = ivec2(trans*vec2(pixcmd.CMDXB, pixcmd.CMDYB)*upscale);\n"
...
"  pixelOnLine = isOnLine(Pn/upscale, P0/upscale, P1/upscale, a);\n"
"  pixelOnLine = pixelOnLine || (onChange((Pn)/upscale, P0/upscale, P1/upscale, a, int(orientation), cidx, lidx));\n"
"  pixelOnLine = pixelOnLine ||onChangeOpposite(Pn/upscale, P0/upscale, P1/upscale, a, int(orientation), cidx, lidx);\n"
"  if (antialiased) {\n"
"   bool isAliased = false;\n"
"   for (int i = 0; i<upscale.x; i++){\n"
"    isAliased = isAliased || (onChangeAliased((Pn)/upscale, P0/upscale, P1/upscale, a, int(orientation), cidx, lidx));\n"
"   }\n"
"   pixelOnLine = pixelOnLine || isAliased;\n"
"  }\n"
"  if (pixelOnLine) {\n"
