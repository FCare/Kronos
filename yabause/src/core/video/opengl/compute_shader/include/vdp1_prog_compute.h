...
"  if (!pixelOnLine) pixelOnLine = pixelOnLine || (onChange((Pn)/upscale, P0/upscale, P1/upscale, a, int(orientation), cidx, lidx));\n"
"  if (!pixelOnLine) pixelOnLine = pixelOnLine || onChangeOpposite(Pn/upscale, P0/upscale, P1/upscale, a, int(orientation), cidx, lidx);\n"
"  if (antialiased && !pixelOnLine) {\n"
