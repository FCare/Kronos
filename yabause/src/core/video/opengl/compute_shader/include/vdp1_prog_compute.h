...
"}\n"
"bool onChange(ivec2 P, ivec2 P0, float slope, ivec2 a, mat2 trans) {\n"
"  return isOnLine(P+ivec2(trans*ivec2(-a.x,0)), P0, slope, a) && isOnLine(P+ivec2(trans*ivec2(0,a.y)), P0, slope, a);\n"
"}\n"
"void main()\n"
"{\n"
...
"    pixelOnLine = pixelOnLine || ( (lidx == i) && onChange((Pn+ivec2((upscale.x-i)*a.x,-i*a.y))/upscale, P0/upscale, slope, a, trans));\n"
"   }\n"
"   if (greedy) {\n"
"    bool isGreedy = false;\n"
"    for (int i = 0; i<upscale.x; i++){\n"
"     isGreedy = isGreedy || ( (lidx == i) && onChange((Pn+ivec2(-i*a.x,-i*a.y))/upscale, P0/upscale, slope, a, trans));\n"
"    }\n"
