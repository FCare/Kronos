...
"}\n"
"bool onChange(ivec2 P, ivec2 P0, float slope, ivec2 a) {\n"
"  return isOnLine(P+ivec2(-a.x,0), P0, slope, a) && isOnLine(P+ivec2(0,a.y), P0, slope, a);\n"
"}\n"
"void main()\n"
"{\n"
...
"  if (a.x == 0) a.x = 1;\n"
"  if (a.y == 0) a.y = 1;\n"
"  ivec2 delta = a*upscale;\n"
"  P1.x = P1.x+delta.x;\n"
"  vector = vector+delta;\n"
"  int veclong = P1.x-P0.x;\n"
"  bool pixelOnLine = false;\n"
"  int lidx = getLine(Pn.y-P0.y);\n"
"  int PPos = getLine(Pn.y);\n"
"  if((P1.x - P0.x)/upscale.x == 0){\n"
"   pixelOnLine = (Pn.x == P0.x);\n"
"  } else {\n"
"   float slope = float((P1.y-P0.y)/upscale.y)/float((P1.x-P0.x)/upscale.x);\n"
"   int cidx = getColumn(Pn-P0);"
"   pixelOnLine = isOnLine(Pn/upscale, P0/upscale, slope, a) && (lidx == 0);\n"
"   for (int i = 1; i<upscale.x; i++){\n"
"    pixelOnLine = pixelOnLine || ( (lidx == i) && onChange((P+ivec2((upscale.x-i)*a.x,-i*a.y))/upscale, P0/upscale, slope, a));\n"
"   }\n"
"   if (greedy) {\n"
"    bool isGreedy = false;\n"
// "    for (int i = 0; i<upscale.x; i++){\n"
// // "     isGreedy = isGreedy || ( (lidx == i) && onChange((P+ivec2((-i)*a.x,(upscale.x-i)*a.y))/upscale, P0/upscale, slope, a));\n"
// "     isGreedy = isGreedy || ( (lidx == i) && onChange((P+ivec2(-i*a.x,-i*a.y))/upscale, P0/upscale, slope, a));\n"
// "    }\n"
