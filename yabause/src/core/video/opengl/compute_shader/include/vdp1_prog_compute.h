...
"}\n"
"bool onChange(ivec2 P, ivec2 P0, float slope, ivec2 a, int orientation) {\n"
...
"    pixelOnLine = pixelOnLine || ( (lidx == i) && onChange((Pn+ivec2((upscale.x-i)*a.x,-i*a.y))/upscale, P0/upscale, slope, a, int(orientation)));\n"
"   }\n"
"   if (greedy) {\n"
"    bool isGreedy = false;\n"
"    for (int i = 0; i<upscale.x; i++){\n"
"     isGreedy = isGreedy || ( (lidx == i) && onChange((Pn+ivec2(-i*a.x,-i*a.y))/upscale, P0/upscale, slope, a, int(orientation)));\n"
"    }\n"
