...
"   return (cidx>lidx) && isOnLine(P+ivec2( a.x,0), P0, slope) && isOnLine(P+ivec2(0,-a.y), P0, slope);\n"
"  else \n"
"   return (cidx<lidx) && isOnLine(P+ivec2(-a.x,0), P0, slope) && isOnLine(P+ivec2(0, a.y), P0, slope);\n"
"}\n"
...
"  if ((a.x == a.y)^^(orientation==1)) \n"
"   return ((cidx>lidx) && isOnLine(P+ivec2(2*a.x,0), P0, slope) && isOnLine(P+ivec2(0,-a.y), P0, slope)) "
"          || isOnLine(P+ivec2( a.x,0), P0, slope) && isOnLine(P+ivec2(0,-a.y), P0, slope);\n"
"  else \n"
"   return ((cidx<lidx) && isOnLine(P+ivec2(-2*a.x,0), P0, slope) && isOnLine(P+ivec2(0, a.y), P0, slope)) "
"          || isOnLine(P+ivec2(-a.x,0), P0, slope) && isOnLine(P+ivec2(0, a.y), P0, slope);\n"
"}\n"
...
"  }\n"
"  if (!pixelOnLine) pixelOnLine = pixelOnLine || (onChange((Pn)/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx));\n"
"  if (!pixelOnLine) pixelOnLine = pixelOnLine || onChangeOpposite(Pn/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx);\n"
"  if (antialiased && !pixelOnLine) {\n"
"   bool isAliased = false;\n"
"   for (int i = 0; i<upscale.x; i++){\n"
"    isAliased = isAliased || (onChangeAliased((Pn)/upscale, P0/upscale, slope, a, int(orientation), cidx, lidx));\n"
"   }\n"
